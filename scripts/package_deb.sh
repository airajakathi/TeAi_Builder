...
Priority: optional
Architecture: amd64
Depends: libgtk-3-0, libwebkit2gtk-4.1-0, libayatana-appindicator3-1, librsvg2-2, libasound2t64, libnss3, libxss1, libxtst6, libx11-xcb1, libxcb-dri3-0, libgbm1, libdrm2
